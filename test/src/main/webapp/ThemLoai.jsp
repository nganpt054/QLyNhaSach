...
<div class="modal fade" id="myModal" role="dialog">
 ...
 <h2 style="text-align:center">THÊM LOẠI</h2><table align="center">

                        <form action="adminThemLoaiController" method="post">
                        <tbody>
                        <tr style="height:40px">
                            ...
                            <tr style="height:40px">
                                <td>Tên Loại:</td>
                                <td>
                                    <input id="TenLoai" name="TenLoai" type="text" value="">
